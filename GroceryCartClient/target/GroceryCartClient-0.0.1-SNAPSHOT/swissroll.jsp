		...
		<div class="tab-content">
			...
			<div id="products" class="tab-pane fade in active">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="images/swissroll_large.jpg" alt="">
							<div class="caption">
					...
					<div id="about_product">
						...
						<li>A Swiss roll, jelly roll, or cream roll is a type of
							sponge cake roll filled with whipped cream, jam, or icing.</li>

						<li>The origins of the term are unclear. In spite of the name
							Swiss roll, the cake is believed to have originated elsewhere in
							Central Europe, likely Austria.[1] It appears to have been
							invented in the nineteenth century, along with Battenberg,
							doughnuts and Victoria sponge.[2]</li>

						<li>The shape of the Swiss roll has inspired usage as a
							descriptive term in other fields, such as in optics and many
							forms of the term "jelly roll".</li>
						</li>
					</div>
					<br />
