		...
		<div class="tab-content">
			...
			<div id="products" class="tab-pane fade in active">
				...
				<div class="row">
					...
					<div class="col-sm-4">
						<div class="thumbnail">
							<img src="images/peanut_butter_large.jpg" alt="">
							<div class="caption">
								<h4 class="pull-right">$1.99</h4>
								<h4>Peanut Butter Cups</h4>
							</div>
						</div>
					</div>
					...
					<div id="about_product">
						...
						<li>REESE'S Dark Chocolate Peanut Butter Cups</li>
						<li>Even REESE'S Peanut Butter Cups have a dark side.</li>
						<li>The classic peanut butter you love is smothered in rich,
							dark chocolate – simply perfect.</li>
